...
alias newgo='~/scripts/ai-guardrails/project-setup/setup-project-go-cli-base-claude.sh'
alias newjava='~/scripts/ai-guardrails/project-setup/setup-project-java-cli-base-claude.sh'
alias newelixir='~/scripts/ai-guardrails/project-setup/setup-project-elixir-otp-base-claude.sh'
alias newrust='~/scripts/ai-guardrails/project-setup/setup-project-rust-cli-base-claude.sh'
alias newcpp='~/scripts/ai-guardrails/project-setup/setup-project-cpp-cli-base-claude.sh'
alias newkotlin='~/scripts/ai-guardrails/project-setup/setup-project-kotlin-cli-base-claude.sh'
alias newscala='~/scripts/ai-guardrails/project-setup/setup-project-scala-cli-base-claude.sh'
alias newclojure='~/scripts/ai-guardrails/project-setup/setup-project-clojure-cli-base-claude.sh'
alias newgamecpp='~/scripts/ai-guardrails/project-setup/setup-project-cpp-3dgame-base-claude.sh'
...
# List the gitignored entries in one directory only, no recursion. Defaults to the
# current dir. `command ls` bypasses the eza alias, which would feed icons into git.
li() {
  (cd "${1:-.}" && command ls -A | git check-ignore --stdin)
}
